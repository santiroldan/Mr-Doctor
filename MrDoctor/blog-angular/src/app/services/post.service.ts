...
import { HttpClient, HttpHeaders } from '@angular/common/http'; // Para hacer peticiones AJAX y envio de cabeceras
...
export class PostService{
    ...
    create(token, post): Observable <any>{
        // Limpiar campo content de Caracteres especiales HTML para guardar en UTF-8
